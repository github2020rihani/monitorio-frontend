...
export const GET_COUNT_USERS = 'get_count_user';
export const GET_COUNT_USERS_PROFILE = 'get_count_user_profile';
export const GET_COUNT_USERS_REGISTER = 'get_count_user_registre';
export const GET_COUNT_USERS_VISITOR = 'get_count_user_visitor';
export const GET_FEED_POSTS = 'get_feed_posts';
export const CREATE_POST = 'create_post';
export const UPDATE_POST = 'update_post';
//stat projets
export const  GET_COUNT_PROJET_INPROGRESS = 'get_count_projet_inprogresss';
export const  GET_COUNT_PROJET_FINISH = 'get_count_projet_finish' ;
export const  GET_COUNT_PROJET_CREATED = 'get_count_projet_created' ;
export const  GET_COUNT_PROJET_BY_LOCALISATION = 'get_count_projet_by_localisation' ;
export const  GET_COUNT_PROJET_BY_ETAT = 'get_count_projet_by_etat';
export const  GET_COUNT_PROJET_BY_SECTEUR = 'get_count_projet_by_secteur' ;
